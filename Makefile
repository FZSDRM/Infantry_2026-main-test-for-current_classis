##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.7.0-B52] date: [Sun Nov 02 23:35:49 CST 2025] 
##########################################################################################################################
...
modules/master_machine/serialport_protocol.c \
...
#######################################
download_dap:
	openocd -f openocd_dap.cfg -c init -c "reset halt" -c "flash write_image erase $(BUILD_DIR)/$(TARGET).bin 0x08000000" -c "verify_image $(BUILD_DIR)/$(TARGET).bin 0x08000000" -c "reset run" -c shutdown
download_jlink:
